...
public class SearchableMaze implements ISearchable {
    ...
    public AState getStartState() {
        return this.original.getStartPosition() == null ? null : this.newer[this.original.getStartPosition().getRowIndex()][this.original.getStartPosition().getColumnIndex()];
    }
    ...
    public ArrayList<AState> getAllPossibleStates(AState s, int vert, int dio) {
        ...
        if (this.original.get_value(r - 1, c) == 0) {
            if (this.newer[r - 1][c].getCost() == 0.0) {
                this.newer[r - 1][c].setCost((double)vert);
                ret.add(this.newer[r - 1][c]);
            }

            if (this.original.get_value(r - 1, c + 1) == 0 && this.newer[r - 1][c + 1].getCost() == 0.0) {
        ...
        if (this.original.get_value(r, c + 1) == 0) {
            if (this.original.get_value(r - 1, c + 1) == 0 && !ret.contains(this.newer[r - 1][c + 1]) && this.newer[r - 1][c + 1].getCost() == 0.0) {
                this.newer[r - 1][c + 1].setCost((double)dio);
                ret.add(this.newer[r - 1][c + 1]);
            }

            if (this.newer[r][c + 1].getCost() == 0.0) {
        ...
        if (this.original.get_value(r - 1, c) == 0 && this.original.get_value(r - 1, c - 1) == 0 && !ret.contains(this.newer[r - 1][c - 1]) && this.newer[r - 1][c - 1].getCost() == 0.0) {
            this.newer[r - 1][c - 1].setCost((double)dio);
            ret.add(this.newer[r - 1][c - 1]);
        }

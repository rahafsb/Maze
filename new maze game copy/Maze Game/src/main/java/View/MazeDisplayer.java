...
public class MazeDisplayer extends Canvas{
    ...
    StringProperty imageFileNameX = new SimpleStringProperty();
    ...
    public String getImageFileNameX(){ return imageFileNameX.get(); }
    ...
    public void drawMaze(Maze maze){
        ...
        this.imageFileNameX.set("resources/images/waterX.jpg");
        draw();
    }
    ...
    public void drawSolution(Solution solution) {
        Image solImage = null;
        try {
            solImage = new Image(new FileInputStream(getImageFileNameX()));
        } catch (FileNotFoundException e) {
            System.out.println("There is no X image");
        }
